...
urlpatterns = [
    ...
    path('vehicle/<pk>/maintenances', MaintenanceCarListView.as_view(), name='vehicle_maintenance'),
    path('vehicle/<pk>/complaints', ComplaintCarListView.as_view(), name='vehicle_complaint'),
