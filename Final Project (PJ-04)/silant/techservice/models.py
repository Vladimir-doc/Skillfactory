...
from vehicles.models import Vehicle, UserProfile
...
class Complaint(models.Model):
    ...
    method_recovery = models.ForeignKey(RecoveryMethod, null=True, blank=True, on_delete=models.CASCADE, verbose_name='Способ восстановления')
    ...
    def __str__(self):
        return f'{self.date_failure} {self.vehicle}'
