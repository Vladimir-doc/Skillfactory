...
class UserProfile(models.Model):
    ...
    service_company = models.ForeignKey(to='techservice.ServiceCompany',blank=True, null=True, on_delete=models.PROTECT, verbose_name='Сервисная компания')
...
class Vehicle(models.Model):
    vehicle_number = models.CharField(unique=True, max_length=12, verbose_name='Зав. № техники')
    ...
    service_company = models.ForeignKey(to='techservice.ServiceCompany', on_delete=models.CASCADE, verbose_name='Сервисная компания')
